...
__kernel void RotateTiles(__global tinymt32wp_t * d_status, __global int* tiling, const int N) // fix all things with N
{
...
__kernel void UpdateTiles(__global int* tiling1, __global int* tiling2,__global int* tiling3, const int N, const int t)
{
