...
void TriangleDimerTiler::TilingToSVG(tiling &t, std::string filename) {
    ...
    outputFile << "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink=\"http://www.w3.org/1999/xlink\" height=\"433.013\" width=\"500\" viewBox=\"0 0 "<<3/2.0*M<<" "<<3/2.0*M<<"\" preserveAspectRatio=\"none\">\n";
    outputFile << "<defs>\n";
    outputFile << "<g id=\"dR\">  <polygon points = \"1,-0.6666666667 0.5,-0.3333333333 0.5,0.3333333333 0,0.6666666667 0,1.333333333 0.5,1.666666667 1,1.333333333 1,0.6666666667 1.5,0.3333333333 1.5,-0.3333333333\" fill=\"darkblue\" stroke=\"black\" stroke-width=\".05\"/></g>\n";
    outputFile << "<g id=\"dL\">  <polygon points = \"0,-0.6666666667 0.5,-0.3333333333 0.5,0.3333333333 1,0.6666666667 1,1.333333333 0.5,1.666666667 0,1.333333333 0,0.6666666667 -0.5,0.3333333333 -0.5,-0.3333333333\" fill=\"darkred\" stroke=\"black\" stroke-width=\".05\"/></g>\n";
    outputFile << "<g id=\"dH\">  <polygon points = \"0,-0.6666666667 0.5,-0.3333333333 1,-0.6666666667 1.5,-0.3333333333 1.5,0.3333333333 1,0.6666666667 0.5,0.3333333333 0,0.6666666667 -0.5,0.3333333333 -0.5,-0.3333333333\" fill=\"darkgreen\" stroke=\"black\" stroke-width=\".05\"/></g>\n";
    outputFile << "</defs>\n";
...
void TriangleDimerTiler::DimerToSVG(tiling &t, domain &d, std::string filename) {
    ...
    outputFile << "<g id=\"eR\">  <polyline points= \".5,1 1,0\" stroke=\"black\" stroke-width=\".01\"/> </g>\n"; // edge SW to NE
    outputFile << "<g id=\"eL\">  <polyline points= \".5,1 0,0\" stroke=\"black\" stroke-width=\".01\"/> </g>\n"; // edge NW to SE
    outputFile << "<g id=\"eH\">  <polyline points= \"1,0 0,0\" stroke=\"black\" stroke-width=\".01\"/> </g>\n"; // edge horizontal
